...
<sparql:construct var="graph" endpoint="${ld4l}">
    CONSTRUCT { ?s ?p ?o . ?s <http://www.cerl.org/namespaces/thesaurus/signOrDevice> ?sign . ?sign <http://www.cerl.org/namespaces/thesaurus/hasDescription> ?desc . ?s <http://rdvocab.info/ElementsGr2/placeAssociatedWithTheCorporateBody> ?addr . ?addr <http://rdvocab.info/ElementsGr3/nameOfThePlace> ?name } WHERE {
	    {
	      ?s ?p ?o .
    ...
    UNION
        {
          ?s <http://rdvocab.info/ElementsGr2/placeAssociatedWithTheCorporateBody> ?addr .
