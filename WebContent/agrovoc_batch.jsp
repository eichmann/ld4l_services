...
<${row.s}>   <http://vivoweb.org/ontology/core#rank>   "${offset}" .
	<jsp:include page="agrovoc_lookup.jsp">
		<jsp:param value="${row.s}" name="uri"/>
	</jsp:include>
</c:forEach>

<lucene:search lucenePath="/usr/local/RAID/LD4L/lucene/agrovoc" label="content" queryParserName="ld4l" queryString="${param.query}" useStemming="true">
