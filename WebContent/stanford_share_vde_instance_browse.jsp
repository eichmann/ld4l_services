...
<div id="centerCol">
<h2>Stanford SHARE VDE Instance: ${param.subject} URI: ${param.uri}</h2>

<sparql:setEndpoint var="vde" sparqlURL="http://services.ld4l.org/fuseki/stanford_share_vde/sparql">
