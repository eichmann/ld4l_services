...
<div id="centerCol">
<h2>MeSH Search</h2>
            <form method='POST' action='mesh.jsp'>
                        ...
                        <lucene:searchIterator>
                           <c:choose>
                                <c:when test="${param.mode == 'triple'}">
                                    <li><a href="mesh_lookup.jsp?uri=<lucene:hit label="uri" />&query=<lucene:hit label="name" />"><lucene:hit label="name" /></a></li>
                                </c:when>
                                <c:otherwise>
                                    <li><a href="mesh_browse.jsp?uri=<lucene:hit label="uri" />&name=<lucene:hit label="name" />"><lucene:hit label="name" /></a></li>
                                </c:otherwise>
                            </c:choose>
                        </lucene:searchIterator>
                    </ol>
