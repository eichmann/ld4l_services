...
<div id="centerCol">
<h2>Cornell SHARE VDE Instance: ${param.subject} URI: ${param.uri}</h2>

<sparql:setEndpoint var="vde" sparqlURL="http://services.ld4l.org/fuseki/cornell_share_vde/sparql">
